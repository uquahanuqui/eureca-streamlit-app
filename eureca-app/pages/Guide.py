...
#내용
st.markdown("<p style='font-size: 20px; font-weight: bold;'>회원가입 안내</p>", unsafe_allow_html=True)
st.write(" ")
#회원가입 사진
...
st.markdown("<p style='font-size: 20px; font-weight: bold;'>주문 안내</p>", unsafe_allow_html=True)
st.write(" ")
...
st.markdown("<p style='font-size: 20px; font-weight: bold;'>결제 안내</p>", unsafe_allow_html=True)
st.write(" ")
...
st.markdown("<p style='font-size: 20px; font-weight: bold;'>픽업 및 수령 안내</p>", unsafe_allow_html=True)
st.write(" ")
...
st.markdown("<p style='font-size: 20px; font-weight: bold;'>교환/반품 안내</p>", unsafe_allow_html=True)
st.write(" ")
st.write("교환 및 반품 방법")
st.write(" ")
...
st.markdown("<p style='font-size: 20px; font-weight: bold;'>환불 안내</p>", unsafe_allow_html=True)
st.write(" ")
...
st.markdown("<p style='font-size: 20px; font-weight: bold;'>기타 안내</p>", unsafe_allow_html=True)
st.write(" ")
