...
with col1:
    st.write("<div style='display: flex; margin-right: 500px;'><a href='https://www.lens-me.com/shop/' style='font-size: 14px; text-align: center;'>INSTAGRAM</a></div>", unsafe_allow_html=True)
...
with col3:
    st.write("<div style='display: flex; margin-right: 500px;'><a href='https://www.i-dol.kr/' style='font-size: 14px; text-align: center;'>KAKAO CHANNEL</a></div>", unsafe_allow_html=True)
