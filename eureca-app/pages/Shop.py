...
with col2:
    st.write("<div style='display: flex; margin-right: 200px; margin-left: 200px;'><a href='https://o-lens.com/' style='font-size: 14px; text-align: center;'>BLOG</a></div>", unsafe_allow_html=True)
