...
with col1:
    st.markdown("<a href='https://www.lens-me.com/shop/' style='font-size: 14px; margin-right: 10px;'>INSTAGRAM</a>", unsafe_allow_html=True)

with col2:
    st.markdown("<a href='https://o-lens.com/' style='font-size: 14px; margin-right: 10px;'>BLOG</a>", unsafe_allow_html=True)

with col3:
    st.markdown("<a href='https://www.i-dol.kr/' style='font-size: 14px;'>KAKAO CHANNEL</a>", unsafe_allow_html=True)
