...
with col1:
    st.write("<a href='https://www.lens-me.com/shop/' style='font-size: 14px; margin-right: 5px; text-align: center;'>INSTAGRAM</a>", unsafe_allow_html=True)

with col2:
    st.write("<a href='https://o-lens.com/' style='font-size: 14px; margin-right: 5px; text-align: center;'>BLOG</a>", unsafe_allow_html=True)

with col3:
    st.write("<a href='https://www.i-dol.kr/' style='font-size: 14px; margin-right: 5px; text-align: center;'>KAKAO CHANNEL</a>", unsafe_allow_html=True)
