...
with col1:
    st.write("<div style='display: flex; margin-left: 300px'><a href='https://www.lens-me.com/shop/' style='font-size: 14px; text-align: center;'>INSTAGRAM</a></div>", unsafe_allow_html=True)
