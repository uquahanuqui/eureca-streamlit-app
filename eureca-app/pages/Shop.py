...
with st.markdown("<div class='button-container'>"):
    st.write("<a href='https://www.lens-me.com/shop/' class='button'>INSTAGRAM</a>", unsafe_allow_html=True)
    st.write("<a href='https://o-lens.com/' class='button'>BLOG</a>", unsafe_allow_html=True)
    st.write("<a href='https://www.i-dol.kr/' class='button'>KAKAO CHANNEL</a>", unsafe_allow_html=True)
