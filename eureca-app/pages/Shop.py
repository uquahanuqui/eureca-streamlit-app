...
with col1:
    st.markdown("<div style='display: flex; margin-left: 220px;[INSTAGRAM](https://www.instagram.com/lensingray.official/) style='font-size: 14px; text-align: center; color: black;'>INSTAGRAM</a></div>", unsafe_allow_html=True) 
