...
#내용
st.write(" ")
st.markdown("<p style='text-align: center;'>Lens in Gray는 우리가 가장 나다울 수 있도록,</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>매번 렌즈를 사용할 때마다 자신의 컬러에 꼭 맞아 행복한 감정을 간직할 수 있도록,</p>", unsafe_allow_html=True)
...
#프로필
st.divider()
st.markdown("<p style='text-align: center; margin: 5px; line-height: 1.2;'>Lens in Gray Co. Owner Uquahanuqui</p>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; margin: 5px; line-height: 1.2;'>Business Number 20230922</p>", unsafe_allow_html=True)
st.write(" ")
st.write("<p style='text-align: center; margin: 5px;'>CUSTOMER CARE</p>", unsafe_allow_html=True)
st.caption("<p style='text-align: center; margin: 5px;'>Phone +82 10-4536-6713</p>", unsafe_allow_html=True)
st.caption("<p style='text-align: center; margin: 5px;'>Email hyb0320@kookmin.ac.kr</p>", unsafe_allow_html=True)
st.write(" ")
st.write("<p style='text-align: center; margin: 5px;'>OFFICE</p>", unsafe_allow_html=True)
st.caption("<p style='text-align: center; margin: 5px;'>#77 Kookmin University Management Hall, Jeongneung-ro, Seongbuk-gu, Seoul</p>", unsafe_allow_html=True)
...
st.caption("<p style='text-align: center; margin: 5px; line-height: 0.8;'>Phone   +82 10-4536-6713</p>", unsafe_allow_html=True)
st.caption("<p style='text-align: center; margin: 5px; line-height: 0.8;'>Email   hyb0320@kookmin.ac.kr</p>", unsafe_allow_html=True)
st.write(" ")
...
st.caption("<p style='text-align: center; margin: 5px; line-height: 0.8;'><span style='font-size: 14px;'>Phone</span> <span style='margin-right: 8px;'> </span> <span style='font-size: 14px;'>+82 10-4536-6713</span></p>", unsafe_allow_html=True)
