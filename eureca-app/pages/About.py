...
st.write(" ")
st.write("<p style='text-align: center; margin: 5px; line-height: 0.8;'>CUSTOMER CARE</p>", unsafe_allow_html=True)
...
st.write(" ")
st.write("<p style='text-align: center; margin: 5px; line-height: 0.8;'>OFFICE</p>", unsafe_allow_html=True)
