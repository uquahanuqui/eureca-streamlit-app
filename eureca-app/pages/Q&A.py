...
#글씨
st.markdown("<p style='font-size: 30px; font-weight: bold; margin: 0px 0;'>FAQ</p>", unsafe_allow_html=True)
st.markdown("---")
...
st.markdown("---")
st.markdown("<p style='font-size: 30px; font-weight: bold; margin: 0px 0;'>Q&A</p>", unsafe_allow_html=True)
st.markdown("---")
st.write("‣ 주문 문의 :lock:")
