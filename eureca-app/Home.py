...
with col3:
    st.write("<div style='display: flex; margin-left: -95px;'><a href='https://pf.kakao.com/_XSfbG/' style='font-size: 14px; text-align: center; color: black;'>KAKAO CHANNEL</a></div>", unsafe_allow_html=True)
